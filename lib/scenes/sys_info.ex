defmodule ScenicNervesImageExample.Scene.SysInfo do
  use Scenic.Scene
  alias Scenic.Graph
  ...
  def init(_, opts) do
    parrot_path =
      :code.priv_dir(:scenic_nerves_image_example)
    ...
    graph =
      ...
      |> Graph.modify(:parrot, &update_opts(&1, translate: {23, 23}, fill: {:image, {parrot_hash, 255}}))
